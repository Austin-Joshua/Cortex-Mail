  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          <p style={{ fontSize: 13, fontWeight: 700, margin: 0 }}>Install Cortex Mail</p>
          <p style={{ fontSize: 11, color: 'var(--text-3)', margin: '2px 0 0' }}>Add this web app to your home screen</p>
        </div>
      </div>
