...
export const queryKeys = {
  ...
  cortexDrafts: ['cortex-drafts'] as const,
  emailTemplates: ['email-templates'] as const,
  geminiStatus: ['gemini-status'] as const,
  sharedEmails: (search = '') => ['shared-emails', search] as const,
  prioritySuggestions: ['priority-suggestions'] as const,
...
export const SYNC_INVALIDATION_KEYS = [
  ...
  queryKeys.sharedEmails(),
  queryKeys.emailPriority,
